...
const _descriptor_7 = new __compactRuntime.CompactTypeOpaqueString();
...
class _Either_0 {
  alignment() {
    return _descriptor_5.alignment().concat(_descriptor_8.alignment().concat(_descriptor_3.alignment()));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_5.toValue(value_0.is_left).concat(_descriptor_8.toValue(value_0.left).concat(_descriptor_3.toValue(value_0.right)));
  }
}
...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      doStuff: (...args_1) => {
        if (args_1.length !== 1)
          throw new __compactRuntime.CompactError(`doStuff: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined))
          __compactRuntime.type_error('doStuff',
                                      'argument 1 (as invoked from Typescript)',
                                      'example.compact line 26 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        ...
        const result_0 = this.#_doStuff_0(context, partialProofData);
      ...
      publicKey: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined))
          __compactRuntime.type_error('publicKey',
                                      'argument 1 (as invoked from Typescript)',
                                      'example.compact line 31 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
  ...
  #_doStuff_0(context, partialProofData) {
    const tmp_0 = 1n;
    Contract._query(context,
                    partialProofData,
                    [
