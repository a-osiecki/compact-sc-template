...
const secretKeyFran =
  "2af7a3a7439ccb558703f1d1285e6839cb36ec4df6d831c200e532803cd2d5b2";
const publicAgus1 = fromHex(
  "7cd3976fad87ce476baedfbbacd86ff0074fe3c228594c83091aec5fc2817886"
);
const fisuraKey = pureCircuits.publicKey(fromHex(secretKeyAgus));
const soditaKey = pureCircuits.publicKey(fromHex(secretKeyFran));
...
export class ContractAPI implements DeployedContractAPI {
      ...
      [
        ...
        from(
          providers.privateStateProvider.get(
            contractPrivateStateKey
          ) as Promise<ContractPrivateState>
        ),
      ],
  ...
  static async join(
    ...
    const deployedBBoardContract = await findDeployedContract<ContractContract>(
      providers,
      {
        contractAddress,
        contract: contractContractInstance,
